...
void set_vp_value(void *cvp_target, const void *cvp_value, const BS_E_TYPE ce_type)
{
...
void *malloc_vp_array(const BS_E_TYPE ce_type, const unsigned long long int culli_length)
{
    void *vp_array = NULL;
    if (ce_type == BS_E_TYPE_S)
